export const styles = {
    nav: `fixed z-50 left-0 top-0 flex w-full justify-between content-center bg-gradient-to-b from-zinc-200 backdrop-blur-2xl`,
    navLine: `w-[1000px] h-20 flex justify-between items-center mx-auto`,
